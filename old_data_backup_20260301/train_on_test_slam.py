#!/usr/bin/env python3
"""
在 test_slam 数据上训练 Text2Loc Visionary 模型
"""
...
def train_model(data_dir: str, output_dir: str, epochs: int = 100, batch_size: int = 16):
    """训练模型"""
    
    print("="*80)
    print("训练 Text2Loc Visionary 模型")
    print("="*80)
    ...
    for epoch in range(epochs):
        ...
        if val_loss < best_val_loss:
            ...
            }, output_path / "test_slam_best_model.pth")
...
def main():
    data_dir = "/Users/yaoyingliang/Desktop/Text2Loc-main/data/k360_test_slam"
    ...
    print("模型训练完成!")
    print("="*80)
    print(f"模型保存位置: {output_dir}/test_slam_best_model.pth")
